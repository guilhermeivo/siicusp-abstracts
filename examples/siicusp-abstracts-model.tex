...
% The SIICUSP logo is not distributed with the package.
% Download the official logo corresponding to the current SIICUSP edition
% and upload it to this project as `siicusp-abstracts-logo.png`.
\usepackage[pt]{siicusp-abstracts}
